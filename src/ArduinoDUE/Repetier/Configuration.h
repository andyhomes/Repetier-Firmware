...
#define MICROSTEP_MODES {MICRO_STEPS,MICRO_STEPS,MICRO_STEPS,MICRO_STEPS,MICRO_STEPS} // [1,2,4,8,16]
...
// Servo pins on a RADDS board are 39,5,6
...
#define Z_PROBE_PIN 32  // z-min probe
