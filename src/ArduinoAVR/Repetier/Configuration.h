...
// Calculations
#define AXIS_STEPS_PER_MM 80 //((float)(MICRO_STEPS * STEPS_PER_ROTATION) / PULLEY_CIRCUMFERENCE)
...
#define EXT0_STEPS_PER_MM 152.63
...
#define EXT0_PID_PGAIN_OR_DEAD_TIME   18.38
/** I-gain. Overridden if EEPROM activated.
*/
#define EXT0_PID_I   1.95
/** Dgain.  Overridden if EEPROM activated.*/
#define EXT0_PID_D 43.35
...
/** P-gain.  Overridden if EEPROM activated. */
#define HEATED_BED_PID_PGAIN_OR_DEAD_TIME   103.95
/** I-gain  Overridden if EEPROM activated.*/
#define HEATED_BED_PID_IGAIN   8.44
/** Dgain.  Overridden if EEPROM activated.*/
#define HEATED_BED_PID_DGAIN 320.19
